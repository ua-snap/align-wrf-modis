...
if __name__ == '__main__':
    ...
    path = '/workspace/Shared/Users/malindgren/MODIS_DATA/WRF_Day_hours/{}_20km_3338_lanczos'.format(variable)
    ...
    for sensor in sensors:
        for metric in metrics:
            for model_group in model_groups:
                ...
                # write to dataframe
                out_fn = os.path.join( out_path, '{}_{}_{}_{}_wrf_tsk_allstations.csv'.format(variable, model_group, sensor, var_lookup[metric]) )
