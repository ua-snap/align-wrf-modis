...
if __name__ == '__main__':
	...
	for station_id in ak_pts.ID:
		...
		out_fn = '/Users/malindgren/Documents/repos/modis_lst/ancillary/{}.csv'.format(str(station_id))
	...
	for metric in ['TMAX', 'TMIN', 'TAVG']:
		...
		out_fn = os.path.join(output_path, 'SNOTEL_points_chena_river_huc_{}.csv'.format(metric.lower()) )
