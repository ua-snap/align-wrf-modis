...
if __name__ == '__main__':
	...
	# args
	base_path = '/workspace/Shared/Tech_Projects/SERDP_Fish_Fire/project_data/MODIS_DATA/raw'
	...
	df = pd.DataFrame( out )
	df.to_csv( os.path.join(os.path.dirname(base_path),'ancillary','MODIS_LST_8dayComposite_begin_end_range_metadata.csv' ) )
	...
	new_df.to_csv( os.path.join(os.path.dirname(base_path),'ancillary','MODIS_LST_8dayComposite_begin_end_range_metadata_final.csv') )