...
if __name__ == '__main__':
	...
	# input pathing
	group = 'acis'
	base_path = '/workspace/Shared/Tech_Projects/SERDP_Fish_Fire/project_data/STATION_DATA'
	# data_path = os.path.join( base_path, group, 'prepped' ) # to run the prepped data
	data_path = os.path.join( base_path, group, '8day' ) # to run the 8-day aggregated data
